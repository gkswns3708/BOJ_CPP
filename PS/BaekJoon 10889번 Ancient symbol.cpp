...
"*""e6K44ve5N56<ca%9e]c7Xa1hc4>64]c5wb6Mb3gbbkb9x67]04M39Gf7<44Wd""cx""94mde^4ai26#4c!23H3f<edj39k32jf7i44rdc a1<8e&9c%";
const char* u = "!@#$%^&*()1234567890QWERTYUIOPqwertyuiopASD""FG""HJKLasdfghjklZXCVBNMzxcvbnm,./<>?{}[]+=";
const char* def = "2ai05i1eS46s1fy47#22v4c&1""9u""07o5f^10u65Q09R5b%c5%a3!c2I6dzbdZ";
...
void half() {
    int i, j, k, l;for (i = 60; i >= 0; i--) {j = 1. / sr(3600 - i * i);
    l = 1. / sr(900 - i * i);
    for (k = 0; k < 60 - j; k++)v(' '); v('/'); v('*');
         for (k++; k < 60 + j; k++) {
            if (0 <= i && i < 30) {if (i == 10 && k == 90)pr(def, &k);
